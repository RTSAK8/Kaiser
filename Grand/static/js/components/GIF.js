const GIF = function () {
    ...
    const GIF_FILE = { // gif file data headers
        GCExt: 0xF9, COMMENT: 0xFE, APPExt: 0xFF, UNKNOWN: 0x01, // not sure what this is but need to skip it in parser
        IMAGE: 0x2C, EOF: 59,   // This is entered as decimal
        EXT: 0x21,
    }
    ...
    function playing() {
        ...
        if (gif.playSpeed === 0) {
            ...
            if (gif.playSpeed < 0) {
                ...
                delay = -gif.frames[frame].delay / gif.playSpeed;
            } else {
                gif.currentFrame += 1;
